...
class Ui_SelectEfitNe(object):
    def setupUi(self, SelectEfitNe):
        ...
        self.gridLayout = QtGui.QGridLayout(SelectEfitNe)
        ...
        self.tbOpen = QtGui.QToolButton(self.frame_2)
        self.tbOpen.setObjectName(_fromUtf8("tbOpen"))
        self.gridLayout_3.addWidget(self.tbOpen, 0, 2, 1, 1)
    ...
    def retranslateUi(self, SelectEfitNe):
        ...
        self.rbMdsPlus.setText(_translate("SelectEfitNe", "MDS+", None))
        self.label_2.setText(_translate("SelectEfitNe", "Gfile Dir:", None))
        self.tbOpen.setText(_translate("SelectEfitNe", "...", None))
        self.label_3.setText(_translate("SelectEfitNe", "Data Dir:", None))
        self.tbData.setText(_translate("SelectEfitNe", "...", None))
        self.checkBox_2.setText(_translate("SelectEfitNe", "CheckBox", None))
        self.checkBox.setText(_translate("SelectEfitNe", "CheckBox", None))
