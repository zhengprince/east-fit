...
#
# Created: Thu Jan 12 14:23:36 2017
...
class Ui_SelectEfitTe(object):
    def setupUi(self, SelectEfitTe):
        ...
        SelectEfitTe.resize(505, 742)
        self.gridLayout_4 = QtGui.QGridLayout(SelectEfitTe)
        self.gridLayout_4.setObjectName(_fromUtf8("gridLayout_4"))
        self.frame_6 = QtGui.QFrame(SelectEfitTe)
        ...
        self.frame_5 = QtGui.QFrame(SelectEfitTe)
        ...
        self.gridLayout_5.addWidget(self.diagnostics5, 4, 0, 1, 1)
    ...
    def retranslateUi(self, SelectEfitTe):
        SelectEfitTe.setWindowTitle(_translate("SelectEfitTe", "Form", None))
        self.label_2.setText(_translate("SelectEfitTe", "Select Efit From:", None))
        self.rbFile_2.setText(_translate("SelectEfitTe", "File", None))
        self.rbMdsPlus_2.setText(_translate("SelectEfitTe", "MDS+ Server", None))
        self.lGFileDir.setText(_translate("SelectEfitTe", "GFile Dir:", None))
        self.tbGFileDir.setText(_translate("SelectEfitTe", "Open", None))
        self.groupBox.setTitle(_translate("SelectEfitTe", "Shot", None))
        self.pbUpdate.setText(_translate("SelectEfitTe", "Update", None))
        self.lTree.setText(_translate("SelectEfitTe", "Tree", None))
        self.lTime.setText(_translate("SelectEfitTe", "Time (ms)", None))
        self.label.setText(_translate("SelectEfitTe", "Select Data From:", None))
        self.rbFile.setText(_translate("SelectEfitTe", "File", None))
        self.rbMdsPlus.setText(_translate("SelectEfitTe", "MDS+ Server", None))
        self.rbRZMap.setText(_translate("SelectEfitTe", "RZ Map", None))
        self.rbRhoMap.setText(_translate("SelectEfitTe", "Rho Map", None))
        self.rbPsiMap.setText(_translate("SelectEfitTe", "Psi Map", None))
        self.lDataDir.setText(_translate("SelectEfitTe", "Data  Dir:", None))
        self.tbData.setText(_translate("SelectEfitTe", "Open", None))
        self.pbTemplates.setText(_translate("SelectEfitTe", "Templates", None))
        self.diagnostics3.setText(_translate("SelectEfitTe", "ECE", None))
        self.diagnostics1.setText(_translate("SelectEfitTe", "Thomson (Core)", None))
        self.diagnostics2.setText(_translate("SelectEfitTe", "Thomson (Edge)", None))
        self.diagnostics4.setText(_translate("SelectEfitTe", "Michelson", None))
        self.diagnostics5.setText(_translate("SelectEfitTe", "TXCS", None))
