...
# Form implementation generated from reading ui file 'selectefitvt.ui'
#
# Created: Thu Oct 26 22:24:29 2017
...
class Ui_SelectEfitVt(object):
    def setupUi(self, SelectEfitVt):
        SelectEfitVt.setObjectName(_fromUtf8("SelectEfitVt"))
        SelectEfitVt.resize(505, 742)
        self.gridLayout_4 = QtGui.QGridLayout(SelectEfitVt)
        self.gridLayout_4.setObjectName(_fromUtf8("gridLayout_4"))
        self.frame_6 = QtGui.QFrame(SelectEfitVt)
        ...
        self.frame_5 = QtGui.QFrame(SelectEfitVt)
        ...
        self.frame_4 = QtGui.QFrame(SelectEfitVt)
        ...
        self.frame = QtGui.QFrame(SelectEfitVt)
        ...
        self.frame_2 = QtGui.QFrame(SelectEfitVt)
        ...
        self.frame_3 = QtGui.QFrame(SelectEfitVt)
        ...
        self.retranslateUi(SelectEfitVt)
        QtCore.QMetaObject.connectSlotsByName(SelectEfitVt)

    def retranslateUi(self, SelectEfitVt):
        SelectEfitVt.setWindowTitle(_translate("SelectEfitVt", "Form", None))
        self.label_2.setText(_translate("SelectEfitVt", "Select Efit From:", None))
        self.rbFile_2.setText(_translate("SelectEfitVt", "File", None))
        self.rbMdsPlus_2.setText(_translate("SelectEfitVt", "MDS+ Server", None))
        self.lGFileDir.setText(_translate("SelectEfitVt", "GFile Dir:", None))
        self.tbGFileDir.setText(_translate("SelectEfitVt", "Open", None))
        self.groupBox.setTitle(_translate("SelectEfitVt", "Shot", None))
        self.pbUpdate.setText(_translate("SelectEfitVt", "Update", None))
        self.lTree.setText(_translate("SelectEfitVt", "Tree", None))
        self.lTime.setText(_translate("SelectEfitVt", "Time (ms)", None))
        self.label.setText(_translate("SelectEfitVt", "Select Data From:", None))
        self.rbFile.setText(_translate("SelectEfitVt", "File", None))
        self.rbMdsPlus.setText(_translate("SelectEfitVt", "MDS+ Server", None))
        self.rbRZMap.setText(_translate("SelectEfitVt", "RZ Map", None))
        self.rbRhoMap.setText(_translate("SelectEfitVt", "Rho Map", None))
        self.rbPsiMap.setText(_translate("SelectEfitVt", "Psi Map", None))
        self.lDataDir.setText(_translate("SelectEfitVt", "Data  Dir:", None))
        self.tbData.setText(_translate("SelectEfitVt", "Open", None))
        self.pbTemplates.setText(_translate("SelectEfitVt", "Templates", None))
        self.diagnostics1.setText(_translate("SelectEfitVt", "CXRS (Core)", None))
        self.diagnostics2.setText(_translate("SelectEfitVt", "TXCS", None))
...
if __name__ == "__main__":
    ...
    SelectEfitVt = QtGui.QWidget()
    ui = Ui_SelectEfitVt()
    ui.setupUi(SelectEfitVt)
    SelectEfitVt.show()
    sys.exit(app.exec_())
