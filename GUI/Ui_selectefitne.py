...
#
# Created: Wed Apr 20 03:31:16 2016
...
class Ui_SelectEfitNe(object):
    def setupUi(self, SelectEfitNe):
        ...
        self.gridLayout_5.addWidget(self.diagnostics4, 4, 0, 1, 1)
        ...
        self.gridLayout_5.addWidget(self.diagnostics3, 3, 0, 1, 1)
    ...
    def retranslateUi(self, SelectEfitNe):
        self.label.setText(QtGui.QApplication.translate("SelectEfitNe", "Select Efit From:", None, QtGui.QApplication.UnicodeUTF8))
        self.rbFile.setText(QtGui.QApplication.translate("SelectEfitNe", "File", None, QtGui.QApplication.UnicodeUTF8))
        self.rbMdsPlus.setText(QtGui.QApplication.translate("SelectEfitNe", "MDS+ Server", None, QtGui.QApplication.UnicodeUTF8))
        self.rbRZMap.setText(QtGui.QApplication.translate("SelectEfitNe", "RZ Map", None, QtGui.QApplication.UnicodeUTF8))
        self.rbRhoMap.setText(QtGui.QApplication.translate("SelectEfitNe", "Rho Map", None, QtGui.QApplication.UnicodeUTF8))
        self.rbPsiMap.setText(QtGui.QApplication.translate("SelectEfitNe", "Psi Map", None, QtGui.QApplication.UnicodeUTF8))
        self.lGFileDir.setText(QtGui.QApplication.translate("SelectEfitNe", "GFile Dir:", None, QtGui.QApplication.UnicodeUTF8))
        self.tbGFileDir.setText(QtGui.QApplication.translate("SelectEfitNe", "...", None, QtGui.QApplication.UnicodeUTF8))
        self.lDataDir.setText(QtGui.QApplication.translate("SelectEfitNe", "Data  Dir:", None, QtGui.QApplication.UnicodeUTF8))
        self.tbData.setText(QtGui.QApplication.translate("SelectEfitNe", "...", None, QtGui.QApplication.UnicodeUTF8))
        self.groupBox.setTitle(QtGui.QApplication.translate("SelectEfitNe", "Shot", None, QtGui.QApplication.UnicodeUTF8))
        self.bUpdate.setText(QtGui.QApplication.translate("SelectEfitNe", "Update", None, QtGui.QApplication.UnicodeUTF8))
        self.lTree.setText(QtGui.QApplication.translate("SelectEfitNe", "Tree", None, QtGui.QApplication.UnicodeUTF8))
        self.lTime.setText(QtGui.QApplication.translate("SelectEfitNe", "Time", None, QtGui.QApplication.UnicodeUTF8))
        self.diagnostics1.setText(QtGui.QApplication.translate("SelectEfitNe", "Reflectometry", None, QtGui.QApplication.UnicodeUTF8))
        self.diagnostics2.setText(QtGui.QApplication.translate("SelectEfitNe", "Thomson (Core)", None, QtGui.QApplication.UnicodeUTF8))
        self.diagnostics4.setText(QtGui.QApplication.translate("SelectEfitNe", "POINT", None, QtGui.QApplication.UnicodeUTF8))
        self.diagnostics3.setText(QtGui.QApplication.translate("SelectEfitNe", "Thomson (Edge)", None, QtGui.QApplication.UnicodeUTF8))
