...
# Form implementation generated from reading ui file 'dialog6.ui'
#
...
class Ui_Dialog6(object):
    def setupUi(self, Dialog6):
        ...
        Dialog6.resize(680, 337)
        Dialog6.setMaximumSize(QtCore.QSize(680, 337))
        self.gridLayout = QtGui.QGridLayout(Dialog6)
        self.gridLayout.setHorizontalSpacing(10)
        self.gridLayout.setObjectName(_fromUtf8("gridLayout"))
        self.buttonBox = QtGui.QDialogButtonBox(Dialog6)
        ...
        self.spb7 = QtGui.QSpinBox(Dialog6)
        ...
        self.spb8 = QtGui.QSpinBox(Dialog6)
        ...
        self.sld4 = QtGui.QSlider(Dialog6)
        ...
        self.spb3 = QtGui.QSpinBox(Dialog6)
        ...
        self.spb4 = QtGui.QSpinBox(Dialog6)
        ...
        self.sld2 = QtGui.QSlider(Dialog6)
        ...
        self.spb9 = QtGui.QSpinBox(Dialog6)
        ...
        self.spb10 = QtGui.QSpinBox(Dialog6)
        ...
        self.sld5 = QtGui.QSlider(Dialog6)
        ...
        self.spb11 = QtGui.QSpinBox(Dialog6)
        ...
        self.spb12 = QtGui.QSpinBox(Dialog6)
        ...
        self.lNm6 = QtGui.QLabel(Dialog6)
        ...
        self.lDig6 = QtGui.QLabel(Dialog6)
        ...
        self.chb6 = QtGui.QCheckBox(Dialog6)
        ...
        self.sld6 = QtGui.QSlider(Dialog6)
        ...
        self.spb1 = QtGui.QSpinBox(Dialog6)
        ...
        self.spb2 = QtGui.QSpinBox(Dialog6)
        ...
        self.sld1 = QtGui.QSlider(Dialog6)
        ...
        self.spb5 = QtGui.QSpinBox(Dialog6)
        ...
        self.spb6 = QtGui.QSpinBox(Dialog6)
        ...
        self.lNm3 = QtGui.QLabel(Dialog6)
        ...
        self.lDig3 = QtGui.QLabel(Dialog6)
        ...
        self.chb3 = QtGui.QCheckBox(Dialog6)
        ...
        self.sld3 = QtGui.QSlider(Dialog6)
        ...
        QtCore.QObject.connect(self.buttonBox, QtCore.SIGNAL(_fromUtf8("rejected()")), Dialog6.reject)
    ...
    def retranslateUi(self, Dialog6):
        Dialog6.setWindowTitle(_translate("Dialog6", "Manual Fit", None))
        self.spb7.setToolTip(_translate("Dialog6", "Max Value", None))
        self.spb8.setToolTip(_translate("Dialog6", "Min Value", None))
        self.lNm4.setToolTip(_translate("Dialog6", "SLOPE OR QUADRATIC (IF ZERO DER) INNER", None))
        self.lNm4.setText(_translate("Dialog6", "param No.4", None))
        self.lDig4.setText(_translate("Dialog6", "TextLabel", None))
        self.chb4.setToolTip(_translate("Dialog6", "CHECKED FIXES THE PARAMETER\n"
"UNCHECKED MAKES THE PARAMETER FREE.", None))
        self.sld4.setToolTip(_translate("Dialog6", "SLOPE OR QUADRATIC (IF ZERO DER) INNER", None))
        self.spb3.setToolTip(_translate("Dialog6", "Max Value", None))
        self.spb4.setToolTip(_translate("Dialog6", "Min Value", None))
        self.lNm2.setToolTip(_translate("Dialog6", "FULL WIDTH", None))
        self.lNm2.setText(_translate("Dialog6", "param No.2", None))
        self.lDig2.setText(_translate("Dialog6", "TextLabel", None))
        self.chb2.setToolTip(_translate("Dialog6", "CHECKED FIXES THE PARAMETER\n"
"UNCHECKED MAKES THE PARAMETER FREE.", None))
        self.sld2.setToolTip(_translate("Dialog6", "FULL WIDTH", None))
        self.spb9.setToolTip(_translate("Dialog6", "Max Value", None))
        self.spb10.setToolTip(_translate("Dialog6", "Min Value", None))
        self.lNm5.setToolTip(_translate("Dialog6", "QUADRADIC OR CUBIC (IF ZERO DER) INNER", None))
        self.lNm5.setText(_translate("Dialog6", "param No.5", None))
        self.lDig5.setText(_translate("Dialog6", "TextLabel", None))
        self.chb5.setToolTip(_translate("Dialog6", "CHECKED FIXES THE PARAMETER\n"
"UNCHECKED MAKES THE PARAMETER FREE.", None))
        self.sld5.setToolTip(_translate("Dialog6", "QUADRADIC OR CUBIC (IF ZERO DER) INNER", None))
        self.spb11.setToolTip(_translate("Dialog6", "Max Value", None))
        self.spb12.setToolTip(_translate("Dialog6", "Min Value", None))
        self.lNm6.setToolTip(_translate("Dialog6", "CUBIC OR QUARTIC (IF ZERO DER) INNER", None))
        self.lNm6.setText(_translate("Dialog6", "param No.6", None))
        self.lDig6.setText(_translate("Dialog6", "TextLabel", None))
        self.chb6.setToolTip(_translate("Dialog6", "CHECKED FIXES THE PARAMETER\n"
"UNCHECKED MAKES THE PARAMETER FREE.", None))
        self.sld6.setToolTip(_translate("Dialog6", "CUBIC OR QUARTIC (IF ZERO DER) INNER", None))
        self.spb1.setToolTip(_translate("Dialog6", "Max Value", None))
        self.spb2.setToolTip(_translate("Dialog6", "Min Value", None))
        self.lNm1.setToolTip(_translate("Dialog6", "SYMMETRY POINT", None))
        self.lNm1.setText(_translate("Dialog6", "param No.1", None))
        self.lDig1.setText(_translate("Dialog6", "TextLabel", None))
        self.chb1.setToolTip(_translate("Dialog6", "CHECKED FIXES THE PARAMETER\n"
"UNCHECKED MAKES THE PARAMETER FREE.", None))
        self.sld1.setToolTip(_translate("Dialog6", "SYMMETRY POINT", None))
        self.spb5.setToolTip(_translate("Dialog6", "Max Value", None))
        self.spb6.setToolTip(_translate("Dialog6", "Min Value", None))
        self.lNm3.setToolTip(_translate("Dialog6", "HEIGHT", None))
        self.lNm3.setText(_translate("Dialog6", "param No.3", None))
        self.lDig3.setText(_translate("Dialog6", "TextLabel", None))
        self.chb3.setToolTip(_translate("Dialog6", "CHECKED FIXES THE PARAMETER\n"
"UNCHECKED MAKES THE PARAMETER FREE.", None))
        self.sld3.setToolTip(_translate("Dialog6", "HEIGHT", None))
