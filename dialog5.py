...
class Dialog5(QtGui.QDialog, Ui_Dialog5):
    ...
    temp = param.Globalvar5.book['Params']  # 临时存储
    ...
    def reset(self):
        ...
        self.spb11.setValue(-100)
        self.spb12.setValue(100)
    ...
    def _initial(self):
        ...
        if len(param.Globalvar5.book['Params']) == 0:
            self.reset()
        else:
            self.chb1.setCheckState(param.Globalvar5.book['Params'][2][0])
            self.chb2.setCheckState(param.Globalvar5.book['Params'][2][1])
            self.chb3.setCheckState(param.Globalvar5.book['Params'][2][2])
            self.chb4.setCheckState(param.Globalvar5.book['Params'][2][3])
            self.chb5.setCheckState(param.Globalvar5.book['Params'][2][4])
            self.spb1.setValue(param.Globalvar5.book['Params'][1][0][0])
            self.spb2.setValue(param.Globalvar5.book['Params'][1][0][1])
            self.spb3.setValue(param.Globalvar5.book['Params'][1][1][0])
            self.spb4.setValue(param.Globalvar5.book['Params'][1][1][1])
            self.spb5.setValue(param.Globalvar5.book['Params'][1][2][0])
            self.spb6.setValue(param.Globalvar5.book['Params'][1][2][1])
            self.spb7.setValue(param.Globalvar5.book['Params'][1][3][0])
            self.spb8.setValue(param.Globalvar5.book['Params'][1][3][1])
            self.spb9.setValue(param.Globalvar5.book['Params'][1][4][0])
            self.spb10.setValue(param.Globalvar5.book['Params'][1][4][1])
            self.spb11.setValue(param.Globalvar5.book['Params'][1][5][0])
            self.spb12.setValue(param.Globalvar5.book['Params'][1][5][1])
            ...
            self.sld1.setValue(param.Globalvar5.book['Params'][0][0])
            self.sld2.setValue(param.Globalvar5.book['Params'][0][1])
            self.sld3.setValue(param.Globalvar5.book['Params'][0][2])
            self.sld4.setValue(param.Globalvar5.book['Params'][0][3])
            self.sld5.setValue(param.Globalvar5.book['Params'][0][4])
            self.sld6.setValue(param.Globalvar5.book['Params'][0][5])
            self.lDig1.setNum(self.sld1.value())
            self.lDig2.setNum(self.sld2.value())
            self.lDig3.setNum(self.sld3.value())
            self.lDig4.setNum(self.sld4.value())
